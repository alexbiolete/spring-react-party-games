const ProfileSidebar = ({
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4 space-y-4">
      <div className="bg-gray-600 mx-auto rounded-full w-32 h-32 p-1">
        <div className="bg-gray-800 w-full h-full rounded-full flex justify-center items-center">
          <span className="font-semibold uppercase text-5xl select-none">
